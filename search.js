...
// 测试用例
const testCases = [
    { arr: [1, 3, 5, 7], target: 4, expected: 2 },
    { arr: [1, 3, 5, 7], target: 0, expected: 0 },
    { arr: [1, 3, 5, 7, 8], target: 7, expected: 4 },
    { arr: [1, 3, 5, 7], target: 3, expected: 1 },
...
// });
// 二分查找插入点（存在重复元素）
function binarySearchInsertLeftPositionWithDuplicates(arr, target) {
    let left = 0;
    let right = arr.length - 1;
    while (left <= right) {
        const mid = Math.floor(left + (right - left) / 2);
...
const leftEdgeTestCases = [
    { nums: [1, 3, 5, 7], target: 9, expected: -1 },
    { nums: [1, 3, 5, 7], target: 0, expected: -1 },
    { nums: [1, 3, 5, 7], target: 4, expected: -1 },
    { nums: [1, 3, 5, 7], target: 5, expected: 2 },
...
function binarySearchInsertRightPositionWithDuplicates(nums, target) {
    let left = 0;
...
const duplicateTestCases = [
    { nums: [3, 3, 3, 3], target: 6, expected: [0, 1] },
    { nums: [2, 2, 3, 3], target: 5, expected: [0, 2] },
    { nums: [1, 2, 2, 2, 3], target: 4, expected: [0, 4] },
